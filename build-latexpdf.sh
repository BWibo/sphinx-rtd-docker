...
versions=("3.5.2" "3.5.3" "3.5.4" "4.0.0" "4.0.1" "4.0.2" "4.0.3" "4.1.0" "4.1.1" "4.1.2" "4.2.0" "4.3.0")

for i in "${versions[@]}"; do
  DOCKER_BUILDKIT=1 \
    docker build . \
    -f Dockerfile.latexpdf \
    -t "bwibo/sphinx-rtd-latexpdf:$i" \
    --build-arg BASEIMAGE_TAG="$i"
